...
<div class="card mb-3">
    ...
    <div class="row g-0">
      <div class="col-md-4">
        <img src="{{asset('img/levi.png')}}" class="img-fluid rounded-start" alt="daniel">
      </div>
      <div class="col-md-8">
        <div class="card-body">
          <h5 class="card-title">Lavender Nathania Adelya| 2602108483</h5>
          <h6 class="card-text">Tanggal Lahir : 20 April 2004</h6>
          <h6 class="card-text">Hobi          : Dance</h6>
          <h6 class="card-text">MBTI : ESFP</h6>
          <h6 class="card-text">Instagram : @levilavenderr | <a href="https://www.instagram.com/levilavenderr/">Link</a></h6>
          <br>
