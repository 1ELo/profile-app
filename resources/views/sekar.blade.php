...
<div class="card mb-3">
    <div class="row g-0">
      ...
      <div class="col-md-8">
        <div class="card-body">
          <h5 class="card-title"><b>Sekar</b> Ayu Nadita| 2602166640</h5>
          <h6 class="card-text">Tanggal Lahir : 26 Juli 2004</h6>
          <h6 class="card-text">Hobi          : Baca</h6>
          <h6 class="card-text">MBTI : INFJ</h6>
          <h6 class="card-text">Instagram : @zaloesan | <a href="https://www.instagram.com/zaloesan/">Link</a></h6>
          <br>
