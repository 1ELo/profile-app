...
<div class="card mb-3">
    <div class="row g-0">
        <div class="col-md-4">
            <img src="{{asset('img/syam.png')}}" class="img-fluid rounded-start" alt="daniel">
        </div>
        <div class="col-md-8">
            <div class="card-body">
                <h5 class="card-title">Tsalasa Kale <b>Syam</b> Machdita | 2602168425</h5>
                <h6 class="card-text">Tanggal Lahir : 3 Desember 2004</h6>
                <h6 class="card-text">Hobi          : Traveling</h6>
                <h6 class="card-text">MBTI : ENFJ</h6>
                <h6 class="card-text">Instagram : @syam_machidita | <a href="https://www.instagram.com/syam_machdita/">Link</a></h6>
                <br>
